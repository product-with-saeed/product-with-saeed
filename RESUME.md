...
- Building production Django and FastAPI backends for e-commerce, FinTech, and data-driven platforms
- Developing automated data collection systems processing 10K+ records daily
- Architecting scalable database schemas and REST APIs for client applications
- Delivering complete solutions: backend infrastructure, documentation, deployment, and support
- **Key Projects:**
...
- Coordinated with frontend and QA teams to deliver features on schedule

### CTO & Lead Engineer
**Varsan Samaneh Radin** | Tehran | Aug 2019 – Jun 2023

- Owned technical architecture and backend development for multiple SaaS products
- Built production Django applications with PostgreSQL, Redis, and automated data workflows
- Established development standards: code quality, testing, documentation, deployment pipelines
- Mentored engineering team on Python best practices and system design
- Delivered data-intensive projects: web scraping systems, API integrations, analytics platforms

### Senior Python Developer & Software Engineer
**Various Companies** | 2001 – 2019

- 10+ years building backend systems, data processing applications, and integration solutions
- Developed web scraping and automation tools for e-commerce, real estate, and job aggregation
- Notable project: Investment mapping system processing 10,000+ geo-located opportunities from ArcGIS shapefiles
- Built and maintained production systems in Django, Flask, and custom Python frameworks
...
Production-ready Django REST Framework template for FinTech applications with JWT authentication, transaction management, and modular architecture.

**[Production-Grade Scraper Template](https://github.com/product-with-saeed/scrapy-production-template)**  
Complete Scrapy project with PostgreSQL pipeline, Docker deployment, 3 working spiders, and comprehensive documentation. Successfully scraped 1000+ records.
...
Azad University, Mashhad | 1997 – 2001
...
✅ Consistently deliver production-ready, well-documented code with <10% post-launch issues
